...
| :--- | :--- | :--- | :--- | :--- |
| **Monorepo & CI/CD** | COMPLETE | Makefile, Docker Compose, GitHub Actions CI workflow | Docker / Node 20 / Python 3.12 | PASS (Green CI Run 31889040610) |
| **Domain Models & DB** | FUNCTIONAL_BASELINE | PostgreSQL (pgvector), Async SQLAlchemy 2.x, Alembic migrations | PostgreSQL | PASS (37 tests) |
| **Evidence & Provenance** | FUNCTIONAL_BASELINE | Immutable records, SHA-256 checksums, synthetic tutorial guardrails | None | PASS |
| **Data Snapshot Manifest** | FUNCTIONAL_BASELINE | `DataSnapshotManifest` with SHA-256 payload checksums & query provenance | Open Targets / ChEMBL APIs | PASS |
...
| **Resistance Biology** | FUNCTIONAL_BASELINE | `ResistanceEvidenceEngine` modeling replication stress, BRCA reversion, ABCB1 efflux | None | PASS |
...
| **Locked Analysis Runs** | FUNCTIONAL_BASELINE | `AnalysisRunManager` & `TemporalHoldoutBenchmark` historical holdout recovery | None | PASS |
| **HGSOC Discovery POC (`THERADOS-POC-001`)** | FUNCTIONAL_BASELINE | Declarative HGSOC program, public data adapters, ensemble origins, discovery workspace | Open Targets / ChEMBL APIs | PASS |
| **Next.js Web Workspace** | FUNCTIONAL_BASELINE | Therapeutic Program Workspace & HGSOC Discovery UI (`/programs/THERADOS-POC-001/discovery`) | Node.js | PASS (Build clean) |
